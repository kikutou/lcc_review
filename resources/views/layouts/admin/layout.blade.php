...
<div class="page-container">
    ...
    <div class="sidebar-menu">
        <div class="sidebar-header">
            <div class="logo">
                <a href="{{ route('admin_get_admin') }}"><img src="{{ asset('assets/images/icon/logo.png') }}" alt="logo"></a>
            </div>
        </div>
        <div class="main-menu">
                    ...
                    <ul class="metismenu" id="menu">
                        ...
                        >
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                        class="ti-comments"></i><span>コメント</span></a>
                            <ul class="collapse">
                                <li
                                        @if(isset($action) && $action == "index")
                                        class="active"
                        ...
                        >
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                        class="ti-menu-alt"></i><span>カテゴリ</span></a>
                            <ul class="collapse">
                                <li
                                        @if(isset($action) && $action == "index")
                                        class="active"
                        ...
                        >
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                        class="ti-link"></i><span>航空会社</span></a>
                            <ul class="collapse">
                                <li
                                        @if(isset($action) && $action == "index")
                                        class="active"
                        ...
                        >
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                        class="ti-location-pin"></i><span>都市</span></a>
                            <ul class="collapse">
                                <li
                                        @if(isset($action) && $action == "index")
                                        class="active"
                        ...
                        >
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                        class="ti-rss"></i><span>空港情報</span></a>
                            <ul class="collapse">
                                <li
                                        @if(isset($action) && $action == "index")
                                        class="active"
                        ...
                        >
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                        class="ti-id-badge"></i><span>管理員</span></a>
                            <ul class="collapse">
                                <li
                                        @if(isset($action) && $action == "index")
                                        class="active"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right">
                        <h4 class="user-name dropdown-toggle" data-toggle="dropdown">{{ \Illuminate\Support\Facades\Auth::guard("admin")->user()->admin_user }}<i class="fa fa-angle-down"></i></h4>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('admin_get_admin_logout') }}">Log Out</a>
                        </div>
                    </div>
                </div>
            </div>
