                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('admin_post_flight_add')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="flight_number" class="form-control" id="flight_number-input"
                                               name="flight_number" placeholder="便番号を入力してください。"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="start_time-input" name="start_time"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="destination_time-input"
                                               name="destination_time" placeholder=""
                                               　value="{{old('destination_time')}}">
                                    ...
                                    <div class="form-group">
                                        <label for="destination_time-input" class="">コメント</label>
<textarea name="comment" id="flight_comment" class="form-control">{{old('destination_time')}}</textarea>
