          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 mb-4">
                  <a href="{{route('user_get_brand_detail',['id'=> $brand->id]) }}"><img class="brand_img" src="{{ asset($brand->logo_picture) }}" alt="logo"></a>
                </div>
                <!-- name&URL -->
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 mb-4">
                <p class="brand_intro">{{ $brand->intro($brand->brand_introduction) }}...</p>
              </div>
            </div>
            <!-- end intro -->
          </div>
