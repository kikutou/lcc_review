    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-auto">
                <div class="grid-col">
                    <a href="{{ route('user_get_post_index' )}}"
                       class="btn btn-info mb-3">{{ $post->category->category_name }}</a>
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-footer">
                                    <a href="#"
                                       class="badge badge-info">{{ $same_category_post->category->category_name }}</a>
                                    @foreach($post->brands as $brand)
                                        <span>
                        ...
                        @if($same_brand_post->id != $post->id)
                            <div class="col-lg-3 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer">
                                        <a href="#"
                                           class="badge badge-info">{{ $same_brand_post->category->category_name }}</a>
                                        @foreach($post->brands as $brand)
                                            <span>
                    <a href="#" class="badge badge-secondary">{{ $brand->brand_name }}</a>
                  </span>
            ...
            <form action="{{ route('user_post_post_detail', ['id'=> $post->id]) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="custom-control custom-checkbox col-sm-2">
                        <input type="checkbox" class="custom-control-input" name="anonymity" value="1"
                               id="anonymitycheck">
